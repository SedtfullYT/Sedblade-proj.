...
def menug():
    ...
    title=tkinter.Label(menu, text="S҉e҉d҉b҉l҉a҉d҉e҉",  font=("Blackadder ITC", 59, "underline", "bold"), pady=1,bg="black", fg="white")
    boxert=tkinter.Button(menu, text="Hard mode", command=boxer, pady=10, width=150, bg="black", font=("20"), fg="white")
    kickboxert=tkinter.Button(menu, text="Normal mode",command=kickboxer, pady=10, width=150, bg="black", font=("20"), fg="white")
    wrestlert=tkinter.Button(menu, text="Easy mode",command=wrestler, pady=10, width=150, bg="black", font=("20"), fg="white")
