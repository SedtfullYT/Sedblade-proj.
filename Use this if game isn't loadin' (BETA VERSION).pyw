...
def menug():
    ...
    title=tkinter.Label(menu, text="Sedblade", font=("Jokerman", 50, "bold"), pady=50,bg="White", fg="Green")
    boxert=tkinter.Button(menu, text="Hard mode", command=boxer, pady=20, width=150)
    kickboxert=tkinter.Button(menu, text="Normal mode",command=kickboxer, pady=20, width=150)
    wrestlert=tkinter.Button(menu, text="Easy mode",command=wrestler, pady=20, width=150)
